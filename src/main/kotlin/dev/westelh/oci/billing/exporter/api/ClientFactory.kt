...
class ClientFactory(private val region: Region, private val auth: AbstractAuthenticationDetailsProvider) {
    ...
    fun createClient(): ObjectStorageClient = ObjectStorageClient.builder()
            .region(region)
